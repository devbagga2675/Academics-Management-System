...
const ProjectGroupCardFAC = (props) => {
  ...
  const handleMenuClick = (id) => {
    console.log(id);
    // Fixed: Removed undefined 'event' reference
  };
            ...
            {components.map((component, index) => (
              ...
              >
                <CheckCircle
                  sx={{
                    fontSize: 16,
                    color: component.evaluation_done ? "primary.main" : "grey.400",
                  }}
                />
              </Tooltip>
            ))}
...
export default ProjectGroupCardFAC;